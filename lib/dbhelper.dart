...
class DbHelper {
  ...
  void _createDb(Database db, int version) async {
    await db.execute(''
        'CREATE TABLE tamu (id INTEGER PRIMARY KEY AUTOINCREMENT,nama TEXT, alamat TEXT,instansi TEXT,email TEXT, telp TEXT, tujuan TEXT, keterangan TEXTcreateDate TEXT, ttd TEXT, photo TEXT)'
        '');
  }
